...
public class MockVehicleRecordService implements VehicleRecordServiceIF{
	...
	public List<VehicleRecord> prepareVehicleRecords(List<String> surveyData)
		...
		result.add(new VehicleRecord("B", 638379, 638520, 1));
		...
		result.add(new VehicleRecord("B", 25784405, 25784563, 4));
